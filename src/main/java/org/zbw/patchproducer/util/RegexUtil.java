...
public class RegexUtil {
    ...
    public static final String ILINK_PREFIX_PATTERN = "#\\d{6,7}|i[Ll]ink\\s?\\d{6,7}|工单\\s?\\d{6,7}";
    ...
    public static final String ILINK_MSG_PATTERN = "(?<=i[Ll]ink\\s?\\d{6,7}\\s?).*|(?<=#\\d{6,7}\\s?).*|(?<=工单\\s\\d{6,7}\\s?).*";
    ...
    public static final String ILINK_PATTERN = "(#|i[Ll]ink\\s?|工单\\s?).*?(?=#|i[Ll]ink|工单|[;；]|$|\\n)";
